...
namespace OrderPurches.WebApi.Helpers
{
    public static class Helper
    {
        ...
        //inyecta en la configuaracion para que tener un token
        ...
        //Si quiero tomar el id del usuario para mostrar infomracion
